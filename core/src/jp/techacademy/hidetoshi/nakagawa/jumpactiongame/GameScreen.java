package jp.techacademy.hidetoshi.nakagawa.jumpactiongame;
...
public class GameScreen extends ScreenAdapter {
    ...
    Sound mSound1 = Gdx.audio.newSound(Gdx.files.internal("se_maoudamashii_onepoint28.wav"));
    Sound mSound2 = Gdx.audio.newSound(Gdx.files.internal("se_maoudamashii_onepoint29.wav"));
    ...
    public GameScreen(JumpActionGame game) {
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.hidetoshi.nakagawa.jumpactiongame");
    ...
    private void createStage() {
        ...
        while (y < WORLD_HEIGHT - 5) {
            ...
            if (i > 3 && i % 3 == 0) {
                int type2 = mRandom.nextFloat() > 0.6f ? Enemy.ENEMY_TYPE_MOVING : Enemy.ENEMY_TYPE_STATIC;
                float x2 = mRandom.nextFloat() * (WORLD_WIDTH - Enemy.ENEMY_WIDTH);

                Enemy enemy = new Enemy(type2, enemyTexture, 0, 0, 128, 128);
                float y2 = y / 2;
